    ...
    <div>
      ...
      <section className="px-24 my-11 flex flex-col gap-15">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Image src={"/img/akhlak-text.png"} alt="" height={100} width={100} />
          <div className="col-span-2">
            <p className="text-xl break-words flex-1 whitespace-normal">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Saepe
              voluptatibus culpa assumenda, quod corporis fuga! Rem animi
              repudiandae, deserunt necessitatibus rerum nobis quas consequuntur
              hic ut iste provident recusandae quam facere corporis dolorum,
              esse laborum minima culpa vero magni itaque, accusamus commodi?
              Quas officia delectus dolorum molestiae culpa consequuntur quo
              quia harum, iusto, inventore repudiandae eos maxime aliquid?
              Dolores enim, modi excepturi at aliquid et iusto recusandae
              repellendus quos? Voluptatem fugit deleniti ipsa labore natus illo
              necessitatibus molestiae suscipit placeat amet, aperiam itaque,
              aut quisquam magni corporis numquam facilis! Pariatur ab
              voluptatum non praesentium facere beatae obcaecati. Explicabo,
              architecto maxime.
            </p>{" "}
            <Image
      ...
      <section className="px-24 my-11 flex flex-col gap-15">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Image src={"/img/susyanto.png"} alt="" height={100} width={100} />
          <br />
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Image src={"/img/rainoc.png"} alt="" height={100} width={100} />
          <br />
        </div>
      </section>
