...
const SearchPage = () => {
  ...
  return (
    <div className="container mx-auto px-32 mt-6">
      <Breadcrumbs>
      ...
      <div className="flex flex-row mt-12">
        <Input
          classNames={{
            ...
            mainWrapper: "h-full",
            input: "text-default-500 bg-default-400/20 dark:bg-default-500/20",
            inputWrapper:
        ...
        <div className="w-full sm:w-3/4">
          ...
          <ul className="flex gap-2 flex-row items-center justify-center mt-6">
            {range.map((page) => {
              ...
              return (
                <li key={page} aria-label={`page ${page}`} className="w-7 h-7">
                  <button
                    className={cn(
